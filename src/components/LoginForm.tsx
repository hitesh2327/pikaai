...
import { FloatingInputProps, LoginFormProps, ThemeToggleProps } from '../types/login';

const FloatingInput: React.FC<FloatingInputProps> = ({ type, placeholder, onFocus, onBlur, value, onChange }) => {
    return (
...
const LoginForm: React.FC<LoginFormProps> = ({ setFocusedInput, theme, setTheme, onLoginSuccess }) => {
